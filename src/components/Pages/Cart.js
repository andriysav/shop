...
import { CartItem, Form, ShowResults } from '../index';
import { clearCart, removeCartItem, plusCartItem, minusCartItem } from '../../redux/actions/cart';
import cartEmptyImage from '../../assets/img/empty-cart.gif';
    ...
    <div className="container container--cart">
      {totalCount ? (
        ...
        <div className="cart cart--empty">
          ...
          <p>
            Most likely, you have not ordered from us yet.
            <br />
            To order product, go to the main page.
          </p>
